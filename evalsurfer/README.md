...
| **Interface** | [`pipeline.py`](interface/pipeline.py) · [`cli/`](interface/cli/) · [`mcp/`](interface/mcp/) · [`adapters/`](interface/adapters/) | CIMAA **Interface**: full-run pipeline (Metrics enrich → Core → Analysis), CLI, 47-tool MCP server, adapters. |
