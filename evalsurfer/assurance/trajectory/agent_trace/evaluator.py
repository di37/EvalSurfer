"""The deterministic trajectory evaluator.

:class:`TrajectoryEvaluator` compares an agent's actual tool-call trajectory to
an expected specification and reports structured findings. It is stateless,
pure, and standard-library-only; the value objects it produces come from
:mod:`evalsurfer.assurance.trajectory.agent_trace.models` and the dict keys it
