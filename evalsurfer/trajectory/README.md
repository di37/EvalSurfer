# `evalsurfer/trajectory/` — agent tool-call evaluation
...
> **As an MCP tool:** the harness LLM calls this directly via the `evalsurfer[mcp]` server — `trajectory`. See [`../mcp/`](../mcp/) and [`../../docs/mcp.md`](../../docs/mcp.md).
