...
content-derived: :func:`~evalsurfer.dataset.contamination.content_hash` hashes
...
from evalsurfer.dataset.contamination import content_hash as compute_content_hash
