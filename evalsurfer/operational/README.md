...
> **As MCP tools:** the harness LLM calls these directly via the `evalsurfer[mcp]` server — `metrics`, `operational_score`, `cost_per_request`, `token_efficiency`. See [`../mcp/`](../mcp/) and [`../../docs/mcp.md`](../../docs/mcp.md).
