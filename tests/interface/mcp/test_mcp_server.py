...
_TOOLS = {
    ...
    "score_category", "score_overall", "decide", "score_report",
...
class McpServerTest(unittest.TestCase):
    ...
    def test_tools_call_the_deterministic_layer(self) -> None:
        ...
        self.assertEqual(s.score_category([4, 2, None]), 6.0)
        ...
        self.assertIn("diagnostics", report)  # Interface pipeline attaches Analysis block
