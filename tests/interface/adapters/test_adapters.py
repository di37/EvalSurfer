...
class PromptfooAdapterTest(unittest.TestCase):
    def test_all_passing_scores_five(self) -> None:
        ...
        quality = report["metrics"][constants.CATEGORY_QUALITY]
    ...
    def test_all_failing_scores_one_and_fails(self) -> None:
        ...
        (criterion,) = report["metrics"][constants.CATEGORY_QUALITY]["criteria"]
    ...
    def test_report_has_required_keys_and_consistent_decision(self) -> None:
        ...
        for key in ("overall", "metrics", "decision", "top_issues"):
        ...
        # No safety category assessed, so a full "pass" is never reached.
